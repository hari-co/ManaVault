...
"[project]/src/registration-validation.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$registration$2d$validation$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/registration-validation.ts [app-ssr] (ecmascript)");
"use client";
;
;
;
...
function register() {
    ...
    const register = async (e)=>{
        e.preventDefault();
        const validationError = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$registration$2d$validation$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["validateRegistration"])(username, password, confirmPassword);
        if (validationError) {
...
//# sourceMappingURL=_9a3bbda2._.js.map